    ...
    IERC721Metadata // 2 inherited components
{
    ...
    event CancelLockupStream(
        ...
        ConfidentialERC20 indexed asset,
    ...
    event WithdrawFromLockupStream(uint256 indexed streamId, address indexed to, ConfidentialERC20 indexed asset, uint128 amount);
    ...
    function getAsset(uint256 streamId) external view returns (ConfidentialERC20 asset);
    ...
    /// @dev Reverts if `streamId` references a null stream.
    /// @param streamId The stream ID for the query.
    function refundableAmountOf(uint256 streamId) external returns (euint64 refundableAmount);
    ...
    ///
    /// @param streamId The stream ID for the query.
    function streamedAmountOf(uint256 streamId) external  returns (euint64 streamedAmount);
    ...
    /// @dev Reverts if `streamId` references a null stream.
    /// @param streamId The stream ID for the query.
    function withdrawableAmountOf(uint256 streamId) external  returns (euint64 withdrawableAmount);
    ...
    function withdraw(uint256 streamId, address to, euint64 amount) external;
    ...
    function withdrawMax(uint256 streamId, address to) external returns (euint64 withdrawnAmount);
    ...
    /// @param newRecipient The address of the new ownerefundableAmountOfr of the stream NFT.
    /// @return withdrawnAmount The amount withdrawn, denoted in units of the asset's decimals.
    ...
    function withdrawMultiple(uint256[] calldata streamIds, euint64[] calldata amounts) external;
}
